...
class OverviewViewModel : ViewModel() {
    ...
    // (04) Create a coroutine Job and a CoroutineScope using the Main Dispatcher
    ...
    private fun getMarsRealEstateProperties() {
        // (05) Call coroutineScope.launch and place the rest of the code in it
        // (06) Call MarsApi.retrofitService.getProperties() and call await on the Deferred
        // (07) Surround the Retrofit code with a try/catch, and set _response.value appropriately
        // *Solution deviates from course video*
...
//        })
    ...
    // (08) Cancel the Coroutine Job when the ViewModel is finished in onCleared
    // *Solution deviates from course video*
